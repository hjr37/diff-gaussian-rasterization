...
CudaRasterizer::ImageState CudaRasterizer::ImageState::fromChunk(char*& chunk, size_t N)
{
	...
	cub::DeviceScan::InclusiveSum(nullptr, img.scan_size, img.n_contrib, img.n_contrib, N);
	obtain(chunk, img.scanning_space, img.scan_size, 128);
	obtain(chunk, img.n_valid_contrib, N, 128);
	obtain(chunk, img.n_valid_contrib_cumsum, N, 128);
...
void CudaRasterizer::Rasterizer::backward(
	...
	int* gau_id_list, 
	int* pix_id_list,
	float* dgc_dCam_position, 
	float* dpixel_dndcs,
	const float* perspec_matrix,
	float* dgndcs_dviewmatrix,
...
{	
	...
	BACKWARD::render(
		...
		gau_id_list, 
		pix_id_list, 
		imgState.n_valid_contrib_cumsum, 
		dpixel_dndcs,
		dpixel_dinvcovs,
		dL_dgau_depth,
		ddepth_dndcs,
